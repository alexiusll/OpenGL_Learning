...
#pragma region 开窗代码
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "SSAO", nullptr, nullptr);
	if (window == NULL)
	{
...
#pragma endregion
    ...
    // -------------------------
    Shader shaderGeometryPass("9.ssao_geometry.vert", "9.ssao_geometry.frag");
    Shader shaderLightingPass("9.ssao.vert", "9.ssao_lighting.frag");
    Shader shaderSSAO("9.ssao.vert", "9.ssao.frag");
    Shader shaderSSAOBlur("9.ssao.vert", "9.ssao_blur.frag");
    ...
    for (unsigned int i = 0; i < 64; ++i)
    {
        ...
        // 目前，所有的样本都是平均分布在采样核心里的，
        // 但是我们更愿意将更多的注意放在靠近真正片段的遮蔽上，也就是将核心样本靠近原点分布。
